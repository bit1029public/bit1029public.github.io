...
<div style="float:none;border:solid 1px 000;margin:20px;text-align:center"><img src="/assets/images/research/MFSC_vis.png" width="70%"><br><em>Visualization of Multi-View Fusion</em></div>
<div style="float:none;border:solid 1px 000;margin:20px;text-align:center"><img src="/assets/images/research/MFSC_robust_vis.png" width="70%"><br><em>Robust View Visualization</em></div>